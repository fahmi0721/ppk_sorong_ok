                        ...
                        <form role="form" id='FormDataTambah'>
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio radio-info">
                                    <input type="radio" id="Leveluser" value="user" name="Level" checked="">
                                    <label for="inlineRadio1"> User </label>
                                </div>
                                <div class="radio radio-info">
                                    <input type="radio" id="Levelpimpinan" value="pimpinan" name="Level" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter Username" autocomplete=off name='Username' id='Username' class="form-control">
                            </div>
