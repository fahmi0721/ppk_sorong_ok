    ...
    <div class="col-sm-8">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>Tambah Dokumen Berita Acara Pemeriksaan Hasil Pekerjaan</strong>
            </li>
        </ol>
    </div>
    <div class="col-sm-4">
    ...
    <div class="col-lg-12">
        <div class="ibox">
            <div class="ibox-title">
                <h5>Tambah Dokumen Berita Acara Pemeriksaan Hasil Pekerjaan </h5>
                ...
                <div class="row">
                    <div class="col-sm-8 b-r">
                        <form role="form" id='FormDataTambah'>
                            ...
                            <input type="hidden" name="NoSuratPphp" id="NoSuratPphp" value='<?= $pphp['NoSurat'] ?>'>
                            ...
                            <div class="form-group">
                                ...
                                <option value=""></option>
                                    <?php foreach($pemeriksa as $item): ?>
                                        <option value="<?= $item['Kode'] ?>"><?= $item['NoSk']; ?> [<?= $item['Nama'] ?>]</option>
                                    <?php endforeach ?>
                                </select>
                            </div>
