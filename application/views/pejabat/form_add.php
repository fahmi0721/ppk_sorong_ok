                    ...
                    <div class="col-sm-8 b-r">
                        <form role="form" id='FormDataTambah'>
                            <div class="form-group">
                                <label>NIP</label> 
                                <input type="text" placeholder="Enter NIP" autocomplete=off class="form-control" name='Nip' id='Nip'>
                            </div>
                            <div class="form-group">
                                <label>Nama</label> 
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" rows='5' placeholder="Enter Deskripsi Jabatan" autocomplete=off name='DeskripsiJabatan' id='DeskripsiJabatan' class="form-control"></textarea>
                            </div>

                            <div class="form-group">
                                <label>Alamat</label> 
                                <textarea type="text" rows='5' placeholder="Enter Alamat" autocomplete=off name='Alamat' id='Alamat' class="form-control"></textarea>
                            </div>
