<script>
    ...
    function Validasi(){
        var iData = ["#NoSurat","#Tgl","#TglPermintaan","#KodePejabat"];
        var iKet = ["Nomor Surat belum lengkap!","Tanggal Surat belum lengkap!","Tanggal Permintaan Pemeriksaan belum lengkap!","Pejabat yang bertanda tanngan belum dipilih!"];
