<script>
    ...
    function Validasi(){
        var iData = ["#Nomor","#Tanggal","#Nama","#NoPengesahaan"];
        var iKet = ["Nomor Akta belum lengkap!","Tanggal belum lengkap!","Nama Notaris belum lengkap!","No Pengesahaanbelum lengkap!"];
    ...
    function Submit(){
        if(Validasi() != false){
            ...
            $.ajax({
                type : "POST",
                url : "<?= base_url('pl_penawaran/update_lh'); ?>",
                data : iData,
                success: function(r){
