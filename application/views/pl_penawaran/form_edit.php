                    ...
                    <div class="col-sm-8 b-r">
                        <form role="form" id='FormData'>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="<?= $data->NoPl ?>" placeholder="Nomor PL" autocomplete=off class="form-control" name='NoPl' id='NoPl'>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Waktu Pelaksanaan" autocomplete=off class="form-control" name='WaktuPelaksanaan' value="<?= $data->WaktuPelaksanaan ?>" id='WaktuPelaksanaan'>
                            </div>

                            <div class="form-group">
                                <label>Masa Berlaku</label> 
                                <input type="text" value="<?= $data->MasaBerlaku ?>" placeholder="Masa Berlaku" autocomplete=off class="form-control" name='MasaBerlaku' id='MasaBerlaku'>
                            </div>

                            <div class="form-group">
                                <label>Vendor</label> 
                                <input type="text" value="<?= $data->Vendor ?>" placeholder="Vendor" autocomplete=off class="form-control" name='Vendor' id='Vendor'>
                            </div>

                            <div class="form-group">
                                <label>Nama Pimpinan Vendor</label> 
                                <input type="text" value="<?= $data->NamaVendor ?>" placeholder="Nama Pimpinan Vendor" autocomplete=off class="form-control" name='NamaVendor' id='NamaVendor'>
                            </div>
...
<?php 
$this->load->view('pl_penawaran/form_edit_js') ?>