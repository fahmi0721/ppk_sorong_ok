    ...
    <div class="col-sm-8">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>Ubah Dokumen Surat Perintah Kerja (SPK)</strong>
            </li>
        </ol>
    </div>
    <div class="col-sm-4">
    ...
    <div class="col-lg-12">
        <div class="ibox">
            <div class="ibox-title">
                <h5>Ubah Dokumen Surat Perintah Kerja (SPK) </h5>
                ...
                <div class="row">
                    <div class="col-sm-8 b-r">
                        <form role="form" id='FormDataUpdate'>
                            <input type="hidden" name="Id" id="Id" value='<?= $spk['Id'] ?>'>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="<?= $spk['NoSpk'] ?>" placeholder="Enter Nomor SPK" autocomplete=off name='NoSpk' id='NoSpk' class="form-control">
                            </div>

                            <div class="form-group data_1">
                                <label>Tanggal SPK (*)</label> 
                                <div class="input-group date">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" placeholder="Enter Tanggal SPK" autocomplete=off name='Tgl' id='Tgl' value="<?= $spk['Tgl'] ?>" class="form-control">
                                </div>
                            </div>

                            <div class="form-group">
                                <label>Nomor Surat Undangan (*)</label> 
                                <input type="text" placeholder="Enter Nomor Surat Undangan" value="<?= $spk['NoSuratUndangan'] ?>" autocomplete=off name='NoSuratUndangan' id='NoSuratUndangan' class="form-control">
                            </div>

                            <div class="form-group data_1">
                                <label>Tanggal Surat Undangan (*)</label> 
                                <div class="input-group date">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" placeholder="Enter Tanggal Surat Undangan" autocomplete=off value="<?= $spk['TglSuratUndangan'] ?>" name='TglSuratUndangan' id='TglSuratUndangan' class="form-control">
                                </div>
                            </div>

                            <div class="form-group">
                                <label>Nomor Berita Acara Hasil Pengadaan Langsung (*)</label> 
                                <input type="text" placeholder="Enter Nomor Berita Acara Hasil Pengadaan Langsung" value="<?= $spk['NoBaPl'] ?>" autocomplete=off name='NoBaPl' id='NoBaPl' class="form-control">
                            </div>

                            <div class="form-group data_1">
                                <label>Tanggal Berita Acara Hasil Pengadaan Langsung (*)</label> 
                                <div class="input-group date">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" placeholder="Enter Tanggal Berita Acara Pengadaan Langsung" autocomplete=off name='TglBaPl' value="<?= $spk['TglBaPl'] ?>" id='TglBaPl' class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group data_2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" value="<?= $spk['TglDari'] ?>" placeholder="Enter Dari" autocomplete=off name='TglDari' id='TglDari' class="awal form-control">
                                    <span class="input-group-addon">S/D</span>
                                    <input type="text" value="<?= $spk['TglSampai'] ?>" placeholder="Enter Sampai" autocomplete=off name='TglSampai' id='TglSampai' class="akhir form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <option value=""></option>
                                    <?php foreach($pejabat as $item): 
                                        $sel = $item['Kode'] === $spk['KodePejabat'] ? "selected" : "";
                                    ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" onkeyup="rupiah(this)" value="<?= $spk['Pembulatan'] ?>" placeholder="Enter Harga Satuan" autocomplete=off name='Pembulatan' id='Pembulatan' class="form-control">
                            </div>
