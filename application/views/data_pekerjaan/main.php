                    ...
                    <table class="table table-striped dataTables-example">
                        ...
                        <tr>
                            ...
                            <td class='text-center'>
                                <div class="btn-group">
                                    <button target='_blank' onclick="window.location='<?= base_url('data_pekerjaan/cetak_pdf/').$item['Id'] ?>'" data-toggle='tooltip' title='Cetak HPS' class="btn btn-outline btn-success btn-xs dim"><i class='fa fa-print'></i></button>
