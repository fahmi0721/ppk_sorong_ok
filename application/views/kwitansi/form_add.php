    ...
    <div class="col-sm-8">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>Tambah Dokumen Kwitansi</strong>
            </li>
        </ol>
    </div>
    <div class="col-sm-4">
                ...
                <div class="row">
                    <div class="col-sm-8 b-r">
                        <form role="form" id='FormDataTambah'>
                            ...
                            <input type="hidden" name="NoBaBayar" id="NoBaBayar" value='<?= $ba_bayar['NoSurat'] ?>'>
                            <div class="form-group">
                                <label>Nomor Bukti (*)</label> 
                                <input type="text" placeholder="Enter Nomor Bukti" autocomplete=off name='NoBukti' id='NoBukti' class="form-control">
                            </div>
