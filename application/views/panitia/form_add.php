    ...
    <div class="col-sm-8">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>Tambah SK Panitia Pemeriksa</strong>
            </li>
        </ol>
    </div>
    <div class="col-sm-4">
    ...
    <div class="col-lg-12">
        <div class="ibox">
            <div class="ibox-title">
                <h5>Tambah SK Panitia Pemeriksa</h5>
                    ...
                    <div class="col-sm-8 b-r">
                        <form role="form" id='FormDataTambah'>
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter Judul SK" autocomplete=off class="form-control" name='Nama' id='Nama'>
                            </div>
                            <div class="form-group">
                                <label>Nomor SK</label> 
                                <input type="text" placeholder="Enter Nomor SK" autocomplete=off name='NoSk' id='NoSk' class="form-control">
                            </div>

                            <div class="form-group">
                                <label>Perihal</label> 
                                <input type="text" placeholder="Enter Perihal" autocomplete=off name='Perihal' id='Perihal' class="form-control">
                            </div>

                           <div class="form-group" id='data_2'>
                                <label>Tahun</label> 
                                <div class="input-group date">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" placeholder="Enter Tahun" autocomplete=off name='Tahun' id='Tahun' class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group" id='data_1'>
                                <label>Tanggal</label> 
                                <div class="input-group date">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" placeholder="Enter Tanggal" autocomplete=off name='Tanggal' id='Tanggal' class="form-control">
                                </div>
                            </div>
                            <hr>
